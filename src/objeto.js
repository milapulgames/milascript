...
Mila.Objeto.mensajesQueSabeResponder = function(objeto) {
...
Mila.Objeto.defineLaClave_DeTipo_ = function(objeto, clave, tipo) {
  ...
  return Mila.Objeto.defineLaClavePropia_(objeto, clave) && objeto[clave].esDeTipo_(tipo);
};
...
Mila.Objeto.defineLasClaves_ = function(objeto, claves) {
  ...
  return claves.esUnTexto() ? Mila.Objeto.defineLaClavePropia_(objeto, claves)
    : claves.esUnaLista() ? claves.todosCumplen_((clave) => Mila.Objeto.defineLaClavePropia_(objeto, clave))
