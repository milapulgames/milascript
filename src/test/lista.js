...
Mila.alIniciar(() => {
  ...
  {i:"let a=[2,4,6];a.Insertar_EnOrden(1);a", o:[1,2,4,6],                d:"Insertar_EnOrden inserta el elemento en la lista y mantiene el orden (1)"},
  {i:"let a=[2,4,6];a.Insertar_EnOrden(3);a", o:[2,3,4,6],                d:"Insertar_EnOrden inserta el elemento en la lista y mantiene el orden (2)"},
  {i:"let a=[2,4,6];a.Insertar_EnOrden(5);a", o:[2,4,5,6],                d:"Insertar_EnOrden inserta el elemento en la lista y mantiene el orden (3)"},
  {i:"let a=[2,4,6];a.Insertar_EnOrden(7);a", o:[2,4,6,7],                d:"Insertar_EnOrden inserta el elemento en la lista y mantiene el orden (4)"},
  {i:"let a=[6,4,2];a.Insertar_EnOrdenSegun_(1,Mila.Tipo.esMayorA_);a",
    o:[6,4,2,1],                                                          d:"Insertar_EnOrdenSegun_ inserta el elemento en la lista y mantiene el orden (1)"},
  {i:"let a=[6,4,2];a.Insertar_EnOrdenSegun_(3,Mila.Tipo.esMayorA_);a",
    o:[6,4,3,2],                                                          d:"Insertar_EnOrdenSegun_ inserta el elemento en la lista y mantiene el orden (2)"},
  {i:"let a=[6,4,2];a.Insertar_EnOrdenSegun_(5,Mila.Tipo.esMayorA_);a",
    o:[6,5,4,2],                                                          d:"Insertar_EnOrdenSegun_ inserta el elemento en la lista y mantiene el orden (3)"},
  {i:"let a=[6,4,2];a.Insertar_EnOrdenSegun_(7,Mila.Tipo.esMayorA_);a",
    o:[7,6,4,2],                                                          d:"Insertar_EnOrdenSegun_ inserta el elemento en la lista y mantiene el orden (4)"},
  {i:"let a=[[],[1,1]];a.Insertar_EnOrdenSegun_([3],(x,r)=>x.length<r.length);a",
    o:[[],[3],[1,1]],                                                     d:"Insertar_EnOrdenSegun_ funciona con estructuras más complejas (1)"},
  {i:"let a=[[],[1,1]];a.Insertar_EnOrdenSegun_([2,2,2],(x,r)=>x.length<r.length);a",
    o:[[],[1,1],[2,2,2]],                                                 d:"Insertar_EnOrdenSegun_ funciona con estructuras más complejas (2)"},
  {i:"let a=[[],[1,1]];a.Insertar_EnOrdenSegun_([2,2],(x,r)=>x.length<r.length);a",
    o:[[],[1,1],[2,2]],                                                   d:"Insertar_EnOrdenSegun_ funciona con estructuras más complejas (3)"},
  {i:"let a=[[],[2,2],[1,1]];a.Insertar_EnOrdenSegun_([3],(x,r)=>x.length<r.length);a",
  ...
  {i:"let a=[2,6,2];a.mejorSegun_(Mila.Tipo.esMayorA_)", o:6,             d:"mejorSegun_ devuelve el máximo de la lista"},
  {i:"let a=[2,6,2];a.mejorSegun_(Mila.Tipo.esMayorA_);a", o:[2,6,2],     d:"mejorSegun_ no modifica la lista"},
  {i:"let a=[3,2,5,1,4];a.ordenadaPor_(Mila.Tipo.esMayorA_)",
    o:[5,4,3,2,1],                                                        d:"ordenadaPor_ devuelve la versión ordenada de lista"},
  {i:"let a=[3,2,5,1,4];a.ordenadaPor_(Mila.Tipo.esMayorA_);a",
    o:[3,2,5,1,4],                                                        d:"ordenadaPor_ no modifica la lista"},
  {i:"let a=[[1,1,1],[1],[1,1]];a.ordenadaPor_((x,r)=>x.length<r.length)",
    o:[[1],[1,1],[1,1,1]],                                                d:"ordenadaPor_ funciona con estructuras más complejas"},
  {i:"let a=[[1,1,1],[2,2],[2,2,2],[1],[1,1],[2]];a.ordenadaPor_((x,r)=>x.length<r.length)",
    o:[[1],[2],[2,2],[1,1],[1,1,1],[2,2,2]],                              d:"ordenadaPor_ mantiene el orden relativo original entre elementos iguales"},
  {i:"let a=[3,2,5,1,4];a.OrdenarPor_(Mila.Tipo.esMayorA_);a",
    o:[5,4,3,2,1],                                                        d:"OrdenarPor_ ordena la lista"},
  {i:"let a=[[1,1,1],[1],[1,1]];a.OrdenarPor_((x,r)=>x.length<r.length);a",
    o:[[1],[1,1],[1,1,1]],                                                d:"OrdenarPor_ funciona con estructuras más complejas"},
  {i:"let a=[[1,1,1],[2,2],[2,2,2],[1],[1,1],[2]];a.OrdenarPor_((x,r)=>x.length<r.length);a",
    o:[[1],[2],[2,2],[1,1],[1,1,1],[2,2,2]],                              d:"OrdenarPor_ mantiene el orden relativo original entre elementos iguales"},
  {i:"let a=[3,2,5,1,4];a.ordenada()", o:[1,2,3,4,5],                     d:"ordenada devuelve la versión ordenada de lista"},
  {i:"let a=[3,2,5,1,4];a.ordenada();a", o:[3,2,5,1,4],                   d:"ordenada no modifica la lista"},
  {i:"let a=[3,2,5,1,4];a.Ordenar();a", o:[1,2,3,4,5],                    d:"Ordenar ordena la lista"}
  ]);
