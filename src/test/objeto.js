...
const aB = soloA+";let b={z:3,x:4};Object.setPrototypeOf(a,b)";
...
Mila.alIniciar(() => Mila.Test.Evaluar_([
  ...
  {i:aConNoEnum+";a.mensajesQueSabeResponder(true)", o:['x','y','hx']
    .concat(Object.getOwnPropertyNames(Object.prototype)),                d:"mensajesQueSabeResponder incluye las no enumerables"},
  ...
  {i:aBConNoEnum+";a.mensajesQueSabeResponder(true)", o:['x','y','hx','z','hz']
    .concat(Object.getOwnPropertyNames(Object.prototype)),                d:"mensajesQueSabeResponder no incluye las del prototipo (3)"},
]));